# Custom TensorFlow ops for fused_bias_act - efficient bias and activation
import os
import numpy as np
...
def _fused_bias_act_cuda(x, b, axis, act, alpha, gain):
    ...
    # Fast version for piecewise-linear activation functions
    @tf.custom_gradient
    ...
    # Slow version for general activation functions
    @tf.custom_gradient
