...
metric_defaults = EasyDict([(args.name, args) for args in [
    EasyDict(name = "fid1k",     func_name = "metrics.frechet_inception_distance.FID", num_imgs = 1000, minibatch_per_gpu = 8),
    EasyDict(name = "fid5k",     func_name = "metrics.frechet_inception_distance.FID", num_imgs = 5000, minibatch_per_gpu = 8),
    EasyDict(name = "fid50k",    func_name = "metrics.frechet_inception_distance.FID", num_imgs = 50000, minibatch_per_gpu = 8),
